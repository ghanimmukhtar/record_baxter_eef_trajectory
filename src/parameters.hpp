...
struct Parameters {
        ...
        double epsilon;
        double the_rate;
        int left_eef_state, right_eef_state;
    };
...
class Data_config{
    ...
    public:
        ...
        ros::ServiceClient& get_left_eef_service_client(){
                return params.left_eef_ac;
            }
        ...
        int get_left_eef_state(){
                return params.left_eef_state;
            }

        int get_right_eef_state(){
                return params.right_eef_state;
            }
        ...
        void set_left_eef_service_client(ros::ServiceClient& eef_ac){
                params.left_eef_ac = eef_ac;
            }
        ...
        void set_left_eef_state(int state){
                params.left_eef_state = state;
            }

        void set_right_eef_state(int state){
                params.right_eef_state = state;
            }
